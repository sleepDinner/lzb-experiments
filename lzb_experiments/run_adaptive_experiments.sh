...
if method_complete "CAT-Net"; then
  ...
  train_adaptive \
    ...
    "catnet" \
    "${CAT_PROFILES:-512,22,0.0001,2;512,16,0.0001,4;512,16,0.0001,2;512,11,0.0001,4;512,11,0.0001,2;512,8,0.0001,4;512,8,0.0001,2;512,4,0.000018,2;512,4,0.000018,0;384,8,0.0001,4;384,4,0.000018,2;256,8,0.0001,4;256,4,0.000018,2}" \
    "$CAT_EPOCHS" \
    "$CAT_WORKERS" \
...
if method_complete "MVSS-Net"; then
  ...
  train_adaptive \
    ...
    "mvssnet" \
    "${MVSS_PROFILES:-512,16,0.0001;512,12,0.0001;512,8,0.0001;512,6,0.0001;512,4,0.000025;512,2,0.0000125;384,16,0.0001;384,12,0.0001;384,8,0.0001;384,6,0.0001;384,4,0.000025;384,2,0.0000125;256,16,0.0001;256,12,0.0001;256,8,0.0001;256,6,0.0001;256,4,0.000025;256,2,0.0000125}" \
    "$MVSS_EPOCHS" \
    "$WORKERS" \
...
if method_complete "PSCC-Net"; then
  ...
  train_adaptive \
    ...
    "psccnet" \
    "${PSCC_PROFILES:-256,10,0.0002;256,8,0.0002;256,4,0.00008;256,2,0.00004;256,1,0.00002}" \
    "$PSCC_EPOCHS" \
    "$WORKERS" \
...
if method_complete "IRIS0-SPAN"; then
  ...
  train_adaptive \
    ...
    "span" \
    "${SPAN_PROFILES:-512,16,0.0001;512,12,0.0001;512,8,0.0001;512,6,0.0001;512,4,0.000025;512,2,0.0000125;384,16,0.0001;384,12,0.0001;384,8,0.0001;384,6,0.0001;384,4,0.000025;384,2,0.0000125;256,16,0.0001;256,12,0.0001;256,8,0.0001;256,6,0.0001;256,4,0.000025;256,2,0.0000125}" \
    "$SPAN_EPOCHS" \
    "$SPAN_WORKERS" \
...
if method_complete "ManTraNet"; then
  ...
  train_adaptive \
    ...
    "mantranet" \
    "${MANTRA_PROFILES:-512,16,0.00001;512,12,0.00001;512,8,0.00001;512,6,0.00001;512,4,0.0000025;512,2,0.00000125;384,16,0.00001;384,12,0.00001;384,8,0.00001;384,6,0.00001;384,4,0.0000025;384,2,0.00000125;256,16,0.00001;256,12,0.00001;256,8,0.00001;256,6,0.00001;256,4,0.0000025;256,2,0.00000125}" \
    "$MANTRA_EPOCHS" \
    "$WORKERS" \
